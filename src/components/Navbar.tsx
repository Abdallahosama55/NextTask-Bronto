  ...
  return (
    <header className='flex px-6 lg:px-9 border-b-[1px] border-[0px] border-[#0000000D] py-4'>
      ...
      <div className='flex items-center lg:gap-5 md:gap-5 gap-3'>
        <div className='relative flex gap-3 px-2 items-center'>
          ...
          <NavbarButton src='/assets/images/message.svg' alt="message" onClick={() => handleDropdownClick('messages')}>
            <div
              className={`absolute top-full right-0 lg:min-w-[450px] mt-2 z-50 text-dark bg-white shadow-lg rounded-xl shadow-custom transition-all duration-300 ease-in-out ${
          ...
          <NavbarButton src="/assets/images/notification-bing.svg" alt="notification" onClick={() => handleDropdownClick('notifications')}>
            <div
              className={`absolute top-full right-0 lg:min-w-[450px] md:min-w-[450px] min-w-[300px]  mt-2 z-50 text-dark bg-white shadow-lg rounded-xl shadow-custom transition-all duration-300 ease-in-out ${
