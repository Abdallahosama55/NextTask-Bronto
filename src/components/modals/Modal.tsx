...
export const Modal: React.FC<ModalProps> = ({ isOpen, onClose, children }) => {
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center z-50 text-[#242731] ">
      ...
      <div className="bg-white rounded-lg p-6 py-0 z-10 relative max-w-lg   mx-12 lg:min-w-[900px] overflow-y-auto max-h-[630px] lg:max-h-[700px] w-full overflow-auto ">
